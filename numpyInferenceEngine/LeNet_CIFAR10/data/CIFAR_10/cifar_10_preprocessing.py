...
Please first download the CIFAR-10 dataset from "https://www.cs.toronto.edu/~kriz/cifar-10-python.tar.gz".
...
train_X, train_Y = load_data(train_files, data_dir, 10)
test_X, test_Y = load_data(test_files, data_dir, 10)
